    ...
    return (
        <section className="font-['Montserrat'] flex justify-center items-center h-screen bg-background">
            <div className="w-full max-w-sm bg-primary p-6 rounded-lg drop-shadow-xl">
                <h1 className="font-medium text-dark-background text-3xl mb-6 text-center">Login</h1>
                <form>
                    <div className="mb-4">
                    ...
                    <div className="flex justify-center">
                        <button type="submit" className="font-semibold bg-theme text-dark-background hover:text-primary py-2 px-4 rounded-md hover:bg-dark-background">Login</button>
                    </div>
                </form>
            </div>
        </section>
