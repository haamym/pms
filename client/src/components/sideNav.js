        ...
        <ul>
          ...
          <li>
            <button
              id="maintainance"
              onClick={handleMenuClick}
              className="flex align-middle text-left hoverable hover:w-full text-[#888484] hover:text-[#fff] hover:bg-primary cursor-pointer  hover:rounded-xl px-3 py-4"
            >
              <svg className='h-5 w-8'
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
